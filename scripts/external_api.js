    ...
    return function(e) {
        ...
        t.parse = function(e, ...n) {
            const i = "object" == typeof n[0] && n[0],
                s = n.length > 1 || !i ? n[0] : void 0,
                o = n.length > 1 && n[1] || i || {},
                a = JSON.parse(e, s);
            return "ignore" === o.protoAction ? a : a && "object" == typeof a && e.match(r) ? (t.scan(a, o), a) : a
        }, t.scan = function(e, t = {}) {
            let n = [e];
            for (; n.length;) {
                const e = n;
                ...
                try {
                    await async function(e) {
                        ...
                        try {
                            ...
                            r.removeAllRanges(), window.document.body.removeChild(t)
                        }
                        if (!s) throw n()
                    }(e)
                } catch (e) {
        ...
        class s extends i.a {
            constructor(...e) {
                var t, n, r;
                super(...e), r = {}, (n = "_storage") in (t = this) ? Object.defineProperty(t, n, {
                    value: r,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
        ...
        function d(e, t = !1, n = "hash") {
            ...
            return s.forEach(e => {
                const n = e.split("="),
                    r = n[0];
                if (!r || r.split(".").some(e => u.includes(e))) return;
                let s;
                try {
                    if (s = n[1], !t) {
                        const e = decodeURIComponent(s).replace(/\\&/, "&");
                        s = "undefined" === e ? void 0 : l.a.parse(e)
                    }
                } catch (e) {
                    return void
                    function(e, t = "") {
        ...
        function m(e) {
            ...
            for (const t of ["config", "interfaceConfig", "devices", "userInfo", "appData"]) {
                const n = p(e[t + "Overwrite"] || e[t] || e[t + "Override"]);
                if (n.length) {
                    let e = `${t}.${n.join(`&${t}.`)}`;
                    o.length ? e = "&" + e : o = "#", o += e
                }
        ...
        class w {
            constructor({
                ...
                this.postis = y()(function(e) {
                    ...
                    return e
                }({}, b, e)), this._receiveCallback = () => {}, this.postis.listen("message", e => this._receiveCallback(e))
            }
            dispose() {
                this.postis.destroy()
            }
        ...
        const O = d(window.location).jitsi_meet_external_api_id,
            x = {};
        let j;
        "number" == typeof O && (x.scope = "jitsi_meet_external_api_" + O), (window.JitsiMeetJS || (window.JitsiMeetJS = {}), window.JitsiMeetJS.app || (window.JitsiMeetJS.app = {}), window.JitsiMeetJS.app).setExternalTransportBackend = e => j.setBackend(e);
        var C = n(0);
        ...
        class M extends i.a {
            constructor(e, ...t) {
                ...
                this._parentNode = s, this._url = N(e, {
                    configOverwrite: o,
                    interfaceConfigOverwrite: c,
                    jwt: l,
                    roomName: n,
                ...
                }), this._createIFrame(i, r, u), this._transport = new L({
                    backend: new w({
                        postisOptions: {
                ...
                }), Array.isArray(d) && d.length > 0 && this.invite(d), this._tmpE2EEKey = f, this._isLargeVideoVisible = !0, this._numberOfParticipants = 0, this._participants = {}, this._myUserID = void 0, this._onStageParticipant = void 0, this._setupListeners(), P++
            }
            _createIFrame(e, t, n) {
                const r = "jitsiConferenceFrame" + P;
                this._frame = document.createElement("iframe"), this._frame.allow = "camera; microphone; display-capture; autoplay; clipboard-write", this._frame.src = this._url, this._frame.name = r, this._frame.id = r, this._setSize(e, t), this._frame.setAttribute("allowFullScreen", "true"), this._frame.style.border = 0, n && (this._frame.onload = n), this._frame = this._parentNode.appendChild(this._frame)
            }
                ...
                this._transport.on("event", e => {
                    ...
                    switch (t) {
                        case "video-conference-joined":
                            void 0 !== this._tmpE2EEKey && (this.executeCommand(I.e2eeKey, this._tmpE2EEKey), this._tmpE2EEKey = void 0), this._myUserID = r, this._participants[r] = {
            ...
            executeCommand(e, ...t) {
                e in I ? this._transport.sendEvent({
                    data: t,
                    name: I[e]
